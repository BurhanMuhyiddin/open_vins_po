...
// ====================   LiGT Problem ========================
    ...
    bool drtVioInit::addFeatureCheckParallax(TimeFrameId frame_id, const FeatureTrackerResulst &image,
                                             double td, bool enforce_insertion) {
        ...
        if (local_active_frames.size() == 0)
        {
            ...
            // std::cout << std::fixed << frame_id << ", " << last_image_t_ns << ", " << std::abs(frame_id - last_image_t_ns) << "\n";
    ...
    bool drtVioInit::checkAccError() {
        ...
        // std::cout << "size: " << int_frameid2_time_frameid.size() << "\n";
        for (int i = 0; i < int_frameid2_time_frameid.size() - 1; i++) {
            int j = i + 1;
            std::cout << std::fixed << int_frameid2_time_frameid.at(j) << ", " << int_frameid2_time_frameid.at(i) << ", " << (int_frameid2_time_frameid.at(j) - int_frameid2_time_frameid.at(i))  << ", " << imu_meas[i].sum_dt_ << "\n";
